...
cls
echo =================================================================
echo    AIDA BOT SETUP AND RUN SCRIPT by @MeoMunDep
echo =================================================================
echo.
...
if exist "..\node_modules" (
    ...
    npm install user-agents axios colors p-limit https-proxy-agent socks-proxy-agent ethers web3 
    cd %~dp0
) else (
...
if not exist configs.json (
    ...
    echo   "referralCode":  ["SQYpH_ay2_DJ9oB", "89yAV139nNLLHIR", "PtAldMxl1kpVprj"]>> configs.json
    echo }>> configs.json
